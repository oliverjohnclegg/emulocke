...
inline constexpr uint16_t kFlagHideCeruleanRival = 0x03C;
inline constexpr uint16_t kFlagHideSsAnneRival = 0x03D;
inline constexpr uint16_t kFlagHideSilphRival = 0x04E;
inline constexpr uint16_t kFlagHideRoute22Rival = 0x04F;
inline constexpr uint16_t kFlagHideTowerRival = 0x051;
